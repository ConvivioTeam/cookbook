...
* Create a new user with a secure password \(see [password policy](../../../client-projects/digital-service-standards/delivery-methodologies/automation/security-standards.md) page\)
